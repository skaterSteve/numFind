...
main()  
{
    ...
    int level_tot = 4;			// Enter the total number of levels
   ...
   while ( level > 0 )  {		// For a given level,
    ...
    a = malloc( N * sizeof( *a ) );     // Allocate memory for N Points
...
//	Uncomment below to check points at every level
